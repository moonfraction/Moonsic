...
const music = new Audio('../../Assets/Artist/atif/songs/1.mp3');
...
const songs = [
    ...
    {
        id: 10,
        name: `Dil Diyan Gallan<br>
        <div class="subtitle">Atif Aslam</div>` ,
        path: '../../Assets/Artist/atif/songs/1.mp3',
        coverPath: '../../Assets/Artist/atif/cover/1.jpg',
    },
    {
        id: 11,
        name: `Pehli Dafa<br>
        <div class="subtitle">Atif Aslam</div>` ,
        path: '../../Assets/Artist/atif/songs/2.mp3',
        coverPath: '../../Assets/Artist/atif/cover/2.jpg',
    },
    {
        id: 12,
        name: `Main Rang Sharbaton Ka<br>
        <div class="subtitle">Atif Aslam</div>` ,
        path: '../../Assets/Artist/atif/songs/3.mp3',
        coverPath: '../../Assets/Artist/atif/cover/3.jpg',
    },
    {
        id: 13,
        name: `O Saathi<br>
        <div class="subtitle">Atif Aslam</div>` ,
        path: '../../Assets/Artist/atif/songs/4.mp3',
        coverPath: '../../Assets/Artist/atif/cover/4.jpg',
    },
    {
        id: 14,
        name: `Tera Hone Laga Hoon<br>
        <div class="subtitle">Atif Aslam, Pritam, Alisha Chinai</div>` ,
        path: '../../Assets/Artist/atif/songs/5.mp3',
        coverPath: '../../Assets/Artist/atif/cover/5.jpg',
    },
    {
        id: 15,
        name: `Jeene Laga Hoon<br>
        <div class="subtitle">Atif Aslam, Shreya Ghoshal</div>` ,
        path: '../../Assets/Artist/atif/songs/6.mp3',
        coverPath: '../../Assets/Artist/atif/cover/6.jpg',
    },
    {
        id: 16,
        name: `Ajnabi<br>
        <div class="subtitle">Atif Aslam</div>` ,
        path: '../../Assets/Artist/atif/songs/7.mp3',
        coverPath: '../../Assets/Artist/atif/cover/7.jpg',
    },
    {
        id: 17,
        name: `Rafta Rafta<br>
        <div class="subtitle">Atif Aslam</div>` ,
        path: '../../Assets/Artist/atif/songs/8.mp3',
        coverPath: '../../Assets/Artist/atif/cover/8.jpg',
    },
    {
        id: 18,
        name: `Dil Meri Na Sune<br>
        <div class="subtitle">Atif Aslam</div>` ,
        path: '../../Assets/Artist/atif/songs/9.mp3',
        coverPath: '../../Assets/Artist/atif/cover/9.jpg',
    },
