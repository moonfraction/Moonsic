const music = new Audio('../../Assets/Artist/chainsmokers/songs/1.mp3');
// music.play(); Autoplay is off by default
const playingArtist = 5;
...
const songs = [
    ...
    {
        id: 10,
        name: `Something Just Like This<br>
        <div class="subtitle">Coldplay, The Chainsmokers
        </div>` ,
        path: '../../Assets/Artist/chainsmokers/songs/1.mp3',
        coverPath: '../../Assets/Artist/chainsmokers/cover/1.jpeg',
    },
    {
        id: 11,
        name: `Roses<br>
        <div class="subtitle">The Chainsmokers</div>` ,
        path: '../../Assets/Artist/chainsmokers/songs/2.mp3',
        coverPath: '../../Assets/Artist/chainsmokers/cover/2.jpg',
    },
    {
        id: 12,
        name: `Closer<br>
        <div class="subtitle">The Chainsmokers</div>` ,
        path: '../../Assets/Artist/chainsmokers/songs/3.mp3',
        coverPath: '../../Assets/Artist/chainsmokers/cover/3.jpg',
    },
    {
        id: 13,
        name: `iPad<br>
        <div class="subtitle">The Chainsmokers</div>` ,
        path: '../../Assets/Artist/chainsmokers/songs/4.mp3',
        coverPath: '../../Assets/Artist/chainsmokers/cover/4.jpg',
    },
    {
        id: 14,
        name: `Paris<br>
        <div class="subtitle">The Chainsmokers</div>` ,
        path: '../../Assets/Artist/chainsmokers/songs/5.mp3',
        coverPath: '../../Assets/Artist/chainsmokers/cover/5.jpg',
    },
