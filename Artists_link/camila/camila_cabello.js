const music = new Audio('../../Assets/Artist/camila/songs/1.mp3');
// music.play(); Autoplay is off by default
const playingArtist = 7;
...
const songs = [
    ...
    //list1 has ids 10- 19
    {
        ...
        path: '../../Assets/Artist/camila/songs/1.mp3',
        coverPath: '../../Assets/Artist/camila/cover/1.jpg',
    },
    {
        id: 11,
        name: `Never Be the Same<br>
        <div class="subtitle">Camila Cabello</div>` ,
        path: '../../Assets/Artist/camila/songs/2.mp3',
        coverPath: '../../Assets/Artist/camila/cover/2.jpg',
    },
    {
        id: 12,
        name: `Havana<br>
        <div class="subtitle">Camila Cabello</div>` ,
        path: '../../Assets/Artist/camila/songs/3.mp3',
        coverPath: '../../Assets/Artist/camila/cover/3.jpg',
    },
    {
        id: 13,
        name: `Bam Bam<br>
        <div class="subtitle">Camila Cabello</div>` ,
        path: '../../Assets/Artist/camila/songs/4.mp3',
        coverPath: '../../Assets/Artist/camila/cover/4.jpg',
    },
    {
        id: 14,
        name: `Senorita<br>
        <div class="subtitle">Camila Cabello, Shawn Mendes</div>` ,
        path: '../../Assets/Artist/camila/songs/5.mp3',
        coverPath: '../../Assets/Artist/camila/cover/5.jpg',
    },
