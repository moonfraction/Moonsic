const music = new Audio('../../Assets/Artist/pritam/songs/1.mp3');
// music.play(); Autoplay is off by default
const playingArtist = 9;
...
const songs = [
    ...
    {
        id: 10,
        name: `Aabaad Barbaad<br>
        <div class="subtitle">Arijit Singh, Pritam</div>` ,
        path: '../../Assets/Artist/pritam/songs/1.mp3',
        coverPath: '../../Assets/Artist/pritam/cover/1.jpeg',
    },
    {
        id: 11,
        name: `Itni Si hasi<br>
        <div class="subtitle">Pritam</div>` ,
        path: '../../Assets/Artist/pritam/songs/2.mp3',
        coverPath: '../../Assets/Artist/pritam/cover/2.jpg',
    },
    {
        id: 12,
        name: `Pehli Nazar Mein<br>
        <div class="subtitle">Pritam, Atif Aslam</div>` ,
        path: '../../Assets/Artist/pritam/songs/3.mp3',
        coverPath: '../../Assets/Artist/pritam/cover/3.jpg',
    },
    {
        id: 13,
        name: `Tu Jaane Na<br>
        <div class="subtitle">Pritam, Atif Aslam</div>` ,
        path: '../../Assets/Artist/pritam/songs/4.mp3',
        coverPath: '../../Assets/Artist/pritam/cover/4.jpeg',
    },
    {
        id: 14,
        name: `Tu Chahiye<br>
        <div class="subtitle">Pritam, Atif Aslam</div>` ,
        path: '../../Assets/Artist/pritam/songs/5.mp3',
        coverPath: '../../Assets/Artist/pritam/cover/5.jpg',
    },
    {
        id: 15,
        name: `Yeh Dooriyan<br>
        <div class="subtitle">Pritam, Mohit Chauhan/div>` ,
        path: '../../Assets/Artist/pritam/songs/6.mp3',
        coverPath: '../../Assets/Artist/pritam/cover/6.jpg',
    },
    {
        id: 16,
        name: `Janam Janam <br>
        <div class="subtitle">Pritam, Arijit Singh, Antara Mitra</div>` ,
        path: '../../Assets/Artist/pritam/songs/7.mp3',
        coverPath: '../../Assets/Artist/pritam/cover/7.jpg',
    },
