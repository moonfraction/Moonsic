const music = new Audio('../../Assets/Artist/shawn/songs/1.mp3');
// music.play(); Autoplay is off by default
const playingArtist = 6;
...
const songs = [
    ...
    //list1 has ids 10- 19
    {
        ...
        name: `Stiches<br>
        <div class="subtitle">Shawn Mendes</div>` ,
        path: '../../Assets/Artist/shawn/songs/1.mp3',
        coverPath: '../../Assets/Artist/shawn/cover/1.jpg',
    },
    {
        id: 11,
        name: `There's Nothing Holding Me Back<br>
        <div class="subtitle">Shawn Mendes</div>` ,
        path: '../../Assets/Artist/shawn/songs/2.mp3',
        coverPath: '../../Assets/Artist/shawn/cover/2.jpeg',
    },
    {
        id: 12,
        name: `Mercy<br>
        <div class="subtitle">Shawn Mendes</div>` ,
        path: '../../Assets/Artist/shawn/songs/3.mp3',
        coverPath: '../../Assets/Artist/shawn/cover/3.webp',
    },
    {
        id: 13,
        name: `Treat You Better<br>
        <div class="subtitle">Shawn Mendes</div>` ,
        path: '../../Assets/Artist/shawn/songs/4.mp3',
        coverPath: '../../Assets/Artist/shawn/cover/4.jpg',
    },
    {
        id: 14,
        name: `Senorita<br>
        <div class="subtitle">Shawn Mendes, Camila Cabello</div>` ,
        path: '../../Assets/Artist/shawn/songs/5.mp3',
        coverPath: '../../Assets/Artist/shawn/cover/5.jpg',
    },
]
