const music = new Audio('../../Assets/Artist/taylor/songs/1.mp3');
// music.play(); Autoplay is off by default
const playingArtist = 4;
...
const songs = [
    ...
    //list1 has ids 10- 19
    {
        id: 10,
        name: `Bad Blood<br>
        <div class="subtitle">Taylor Swift ft. Kendrik Lamar</div>` ,
        path: '../../Assets/Artist/taylor/songs/1.mp3',
        coverPath: '../../Assets/Artist/taylor/cover/1.jpg',
    },
    {
        id: 11,
        name: `Love Story<br>
        <div class="subtitle">Taylor Swift</div>` ,
        path: '../../Assets/Artist/taylor/songs/2.mp3',
        coverPath: '../../Assets/Artist/taylor/cover/2.jpg',
    },
    {
        id: 12,
        name: `Wildest Dreams<br>
        <div class="subtitle">Taylor Swift</div>` ,
        path: '../../Assets/Artist/taylor/songs/3.mp3',
        coverPath: '../../Assets/Artist/taylor/cover/3.jpeg',
    },
    {
        id: 13,
        name: `Lover<br>
        <div class="subtitle">Taylor Swift</div>` ,
        path: '../../Assets/Artist/taylor/songs/4.mp3',
        coverPath: '../../Assets/Artist/taylor/cover/4.jpg',
    },
