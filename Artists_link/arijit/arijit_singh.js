const music = new Audio('../../Assets/Artist/arjit/songs/1.mp3');
// music.play(); Autoplay is off by default
const playingArtist = 3;
...
const songs = [
    ...
    //list1 has ids 10- 19
    {
        ...
        name: `Gerua<br>
        <div class="subtitle">Arijit Singh, Antara Mitra</div>` ,
        path: '../../Assets/Artist/arjit/songs/1.mp3',
        coverPath: '../../Assets/Artist/arjit/cover/1.jpg',
    },
    {
        id: 11,
        name: `Janam Janam<br>
        <div class="subtitle">Arijit Singh, Antara Mitra</div>` ,
        path: '../../Assets/Artist/arjit/songs/2.mp3',
        coverPath: '../../Assets/Artist/arjit/cover/2.jpg',
    },
    {
        id: 12,
        name: `Chal wahan jate hain<br>
        <div class="subtitle">Arijit Singh</div>` ,
        path: '../../Assets/Artist/arjit/songs/3.mp3',
        coverPath: '../../Assets/Artist/arjit/cover/3.jpg',
    },
    {
        id: 13,
        name: `Lo maan liya<br>
        <div class="subtitle">Arijit Singh</div>` ,
        path: '../../Assets/Artist/arjit/songs/4.mp3',
        coverPath: '../../Assets/Artist/arjit/cover/4.jpg',
    },
    {
        id: 14,
        name: `Hawayein<br>
        <div class="subtitle">Arijit Singh, Pritam</div>` ,
        path: '../../Assets/Artist/arjit/songs/5.mp3',
        coverPath: '../../Assets/Artist/arjit/cover/5.jpg',
    },
    {
        id: 15,
        name: `Agar Tum Saath Ho<br>
        <div class="subtitle">Arijit Singh, Alka Yagnik</div>` ,
        path: '../../Assets/Artist/arjit/songs/6.mp3',
        coverPath: '../../Assets/Artist/arjit/cover/6.jpg',
    },
    {
        id: 16,
        name: `Hamari Adhuri Kahani<br>
        <div class="subtitle">Arijit Singh</div>` ,
        path: '../../Assets/Artist/arjit/songs/7.mp3',
        coverPath: '../../Assets/Artist/arjit/cover/7.jpg',
    },
    {
        id: 17,
        name: `Chaleya<br>
        <div class="subtitle">Arijit Singh, Shilpa Rao</div>` ,
        path: '../../Assets/Artist/arjit/songs/8.mp3',
        coverPath: '../../Assets/Artist/arjit/cover/8.jpg',
    },
    {
        id: 18,
        name: `Tujhe Kitna Chahne Lage<br>
        <div class="subtitle">Arijit Singh, Mithoon</div>` ,
        path: '../../Assets/Artist/arjit/songs/9.mp3',
        coverPath: '../../Assets/Artist/arjit/cover/9.jpg',
    },
    {
        id: 19,
        name: `O Zaalima o Zaalima<br>
        <div class="subtitle">Arijit Singh</div>` ,
        path: '../../Assets/Artist/arjit/songs/10.mp3',
        coverPath: '../../Assets/Artist/arjit/cover/10.jpg',
    },
]
