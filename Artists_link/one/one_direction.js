const music = new Audio('../../Assets/Artist/one/songs/1.mp3');
...
const songs = [
    ...
    //list1 has ids 10- 19
    {
        ...
        path: '../../Assets/Artist/one/songs/1.mp3',
        coverPath: '../../Assets/Artist/one/cover/1.jpg',
    },
    {
        id: 11,
        name: `Perfect<br>
        <div class="subtitle">One Direction</div>` ,
        path: '../../Assets/Artist/one/songs/2.mp3',
        coverPath: '../../Assets/Artist/one/cover/2.jpg',
    },
    {
        id: 12,
        name: `18<br>
        <div class="subtitle">One Direction</div>` ,
        path: '../../Assets/Artist/one/songs/3.mp3',
        coverPath: '../../Assets/Artist/one/cover/3.jpeg',
    },
    {
        id: 13,
        name: `What makes you Beautiful!<br>
        <div class="subtitle">One Direction</div>` ,
        path: '../../Assets/Artist/one/songs/4.mp3',
        coverPath: '../../Assets/Artist/one/cover/4.jpg',
    },
