const music = new Audio('../../Assets/Artist/charlie/songs/1.mp3');
// music.play(); Autoplay is off by default
const playingArtist = 2;
...
const songs = [
    ...
    //list1 has ids 10- 19
    {
        ...
        path: '../../Assets/Artist/charlie/songs/1.mp3',
        coverPath: '../../Assets/Artist/charlie/cover/1.webp',
    },
    {
        id: 11,
        name: `Left and Right<br>
        <div class="subtitle">Charlie Puth ft.Jung Kook</div>` ,
        path: '../../Assets/Artist/charlie/songs/2.mp3',
        coverPath: '../../Assets/Artist/charlie/cover/2.jpg',
    },
    {
        id: 12,
        name: `We Don't Talk Anymore<br>
        <div class="subtitle">Charlie Puth, Selena Gomez</div>` ,
        path: '../../Assets/Artist/charlie/songs/3.mp3',
        coverPath: '../../Assets/Artist/charlie/cover/3.jpeg',
    },
    {
        id: 13,
        name: `See You Again<br>
        <div class="subtitle">Wiz Khalifa ft. Charlie Puth</div>` ,
        path: '../../Assets/Artist/charlie/songs/4.mp3',
        coverPath: '../../Assets/Artist/charlie/cover/4.jpg',
    },
    {
        id: 14,
        name: `Cheating on You<br>
        <div class="subtitle">Charlie Puth</div>` ,
        path: '../../Assets/Artist/charlie/songs/5.mp3',
        coverPath: '../../Assets/Artist/charlie/cover/5.png',
    },
    {
        id: 15,
        name: `Charlie Be Quiet!<br>
        <div class="subtitle">Charlie Puth</div>` ,
        path: '../../Assets/Artist/charlie/songs/6.mp3',
        coverPath: '../../Assets/Artist/charlie/cover/6.webp',
    },
    {
        id: 16,
        name: `I Warned Myself<br>
        <div class="subtitle">Charlie Puth</div>` ,
        path: '../../Assets/Artist/charlie/songs/7.mp3',
        coverPath: '../../Assets/Artist/charlie/cover/7.png',
    },
